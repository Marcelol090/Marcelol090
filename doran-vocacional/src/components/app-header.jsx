...
export function AppHeader({ screen, navigate, completed, apiHealth }) {
  return (
    <header className="sticky top-0 z-50 border-b border-border/75 bg-background/88 backdrop-blur-xl supports-[backdrop-filter]:bg-background/76">
      <div className="mx-auto flex min-h-18 w-full max-w-[1240px] items-center justify-between gap-4 px-4 sm:px-6 lg:px-8">
        ...
        <nav className="flex items-center gap-2" aria-label="Navegação principal">
          <ApiStatus health={apiHealth} compact className="hidden md:inline-flex" />
